    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="font-display font-700 text-xl text-forest-800">
              ...
              <span className="text-xs font-sans font-medium text-forest-400 ml-1 align-super">AI</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link to="/dashboard" className="ml-3 btn-primary text-sm py-2 px-5">
              View Wards
            </Link>
          </div>
      ...
      {menuOpen && (
        <div className="md:hidden bg-white/98 backdrop-blur-md border-t border-green-100 px-4 py-4 space-y-1 shadow-lg">
          ...
          <div className="pt-2">
            <Link to="/dashboard" className="btn-primary block text-center text-sm">
              View Wards
            </Link>
          </div>
        </div>
