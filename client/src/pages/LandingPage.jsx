    ...
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-mist via-white to-forest-50 pt-16">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <LeafDecor
            className="top-40 right-[12%] leaf-float-delay"
            size={20}
            delay="0.5s"
          />
          <LeafDecor
            className="bottom-32 left-[20%] leaf-float-slow"
            size={16}
            delay="1s"
          />
          <LeafDecor
            className="top-64 left-[55%] leaf-float"
            size={12}
            delay="2s"
          />
          <LeafDecor
            className="bottom-48 right-[25%] leaf-float-delay"
            size={28}
            delay="0.8s"
          />
        </div>
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center animate-slide-up">
          ...
          <div className="inline-flex items-center gap-2 bg-forest-100 text-forest-700 text-xs font-semibold px-4 py-2 rounded-full mb-8 border border-forest-200">
            ...
            AI-Powered Urban Sustainability Intelligence Platform
          </div>
          ...
          <p className="text-lg sm:text-xl text-forest-600 max-w-2xl mx-auto leading-relaxed mb-10">
            GreenLens AI maps ecological stress across Indore's 85 wards using
            real GIS data, population projections, and Gemini AI — pinpointing
            where the city needs trees, water, and action most.
          </p>
          ...
          <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
            {STATS.map(({ val, label }) => (
              <div key={label} className="glass-card py-4 px-3">
                <div className="font-display font-bold text-2xl text-forest-700">
                  {val}
                </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-14">
            <span className="text-xs font-semibold text-forest-500 uppercase tracking-widest">
              Capabilities
            </span>
            ...
            <p className="text-forest-500 max-w-xl mx-auto">
              Combining real GIS datasets, population projections, and AI to
              surface what matters most for Indore's green future.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map(({ icon: Icon, title, desc, color }) => (
              <div
                key={title}
                className="glass-card p-6 hover:shadow-md transition-all hover:-translate-y-0.5"
              >
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={step} className="flex gap-5 glass-card p-6">
                ...
                <div>
                  <h3 className="font-display font-semibold text-forest-900 mb-1">
                    {title}
                  </h3>
                  <p className="text-sm text-forest-500 leading-relaxed">
                    {desc}
      ...
      <section className="py-24 bg-forest-800 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center px-4">
          ...
          <p className="text-forest-300 text-lg mb-8">
            Explore stress levels, green space gaps, and AI recommendations for
            all 85 wards.
          </p>
          <Link
            to="/dashboard"
            className="inline-flex items-center gap-2 bg-leaf hover:bg-green-500 text-forest-900 font-bold px-8 py-4 rounded-xl transition-all hover:shadow-xl hover:-translate-y-0.5"
          >
            Open Dashboard
            <ArrowRight size={20} />
          </Link>
